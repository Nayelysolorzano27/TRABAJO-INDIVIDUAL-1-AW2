...
class EstudianteController extends Controller
{
     ...
     *                @OA\Property(property="nombre", type="string", example="Andreina Solorzano"),
     *                @OA\Property(property="cedula", type="string", example="1315274835"),
     *                @OA\Property(property="correo", type="string", example="andresolmac@gmail.com"),
     ...
     *      description="Indica que se espere una respuesta en formato JSON"
     * ),
